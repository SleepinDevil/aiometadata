...
## [1.34.0](https://github.com/SleepinDevil/aiometadata/compare/v1.33.3...v1.34.0) (2026-03-15)


### Features

* add 0 cast members option ([fbbd6bc](https://github.com/SleepinDevil/aiometadata/commit/fbbd6bcbe9844954d64d161cc9cc2fc1e432cfe1))
* add anilist to catalog builder ([f62bde8](https://github.com/SleepinDevil/aiometadata/commit/f62bde8df1dbf8833e5091cfad034dec97697fe3))
* add Calendar support for kitsu, mal, anilist, anidb, tmdb, tvdb and tvmaze ids ([4db6628](https://github.com/SleepinDevil/aiometadata/commit/4db662872fad260cbb1952bd5d3bed7d69470a85))
* Add Catalog setup selector ([0a7bf2b](https://github.com/SleepinDevil/aiometadata/commit/0a7bf2bb4a53c78964f6a41eb6239dab677bf5dc))
* Add configurable days ahead for Trakt airing soon catalog ([275e5c9](https://github.com/SleepinDevil/aiometadata/commit/275e5c9812b9a7dc5b14495c14b04999da1081a7))
* add DISABLE_METRICS env var to disable metrics collection ([71c044f](https://github.com/SleepinDevil/aiometadata/commit/71c044ff73d72835418c187213350a9f4e951f21))
* Add easy catalog share option ([af9dc18](https://github.com/SleepinDevil/aiometadata/commit/af9dc182bd9a1b80ae7e07b4a3c5935d85c02393))
* add filtering to kitsu, batch calls better ([ee5249a](https://github.com/SleepinDevil/aiometadata/commit/ee5249a591d427f9368191f40215f89a835a5bcb))
* add HIDIVE as streaming provider ([8e17731](https://github.com/SleepinDevil/aiometadata/commit/8e17731bebeaeb42b47e9c359fc577dbc8dff905))
* add MAL to catalog builder ([9ee2a53](https://github.com/SleepinDevil/aiometadata/commit/9ee2a5383723880c49ee36603f5e83a0c4bcf21d))
* Add MDBList Up Next catalog integration ([3d86bbf](https://github.com/SleepinDevil/aiometadata/commit/3d86bbf845c90897aa48d85a332915aa57362da4))
* add option to choose between proxying or not ratings posters via aiometadata ([eefd151](https://github.com/SleepinDevil/aiometadata/commit/eefd1519148c613842d16b07b569a5e661fb0ceb))
* add polling to dashboard for admin users ([8bd38ff](https://github.com/SleepinDevil/aiometadata/commit/8bd38fff3436265032bcdbe7785bb0149901f5a8))
* add polling to dashboard for admin users ([f199521](https://github.com/SleepinDevil/aiometadata/commit/f19952163b0b5b2ede8c551eba29e5d9b085b255))
* add preset wizard ([ed8cf50](https://github.com/SleepinDevil/aiometadata/commit/ed8cf50d9f3a39d93a838efe302e628042b43272))
* add quick add functionality ([7ced45c](https://github.com/SleepinDevil/aiometadata/commit/7ced45cb06159bd742f5c050bbf60726d89c661b))
* Add Rate Me button as genre in meta pages ([fa2c218](https://github.com/SleepinDevil/aiometadata/commit/fa2c218451297c6c5ebe18cdbcca1a6c99bfee43))
* Add rating page with multi-service support (Trakt, AniList, MDBList) ([228ada5](https://github.com/SleepinDevil/aiometadata/commit/228ada57585b006e362b3b4873f98c07aec6bc97))
* add search pagination support ([696ecd7](https://github.com/SleepinDevil/aiometadata/commit/696ecd779e5c48d78931b03ce04c51bee8ec15d4))
* add simkl builder ([0e4f16c](https://github.com/SleepinDevil/aiometadata/commit/0e4f16cd0bc92eefd72e20ab08dac13184d8f7e0))
* Add sort options for TMDB year and language catalogs ([ca0ac4c](https://github.com/SleepinDevil/aiometadata/commit/ca0ac4c8be792e8d6b6c3aa49d97c712bab25b80))
* add sort options to streaming catalogs ([ed4cdb3](https://github.com/SleepinDevil/aiometadata/commit/ed4cdb39b6574f6e5d4a074138d4b9faa86d7350))
* Add TMDB Lists integration ([510c17b](https://github.com/SleepinDevil/aiometadata/commit/510c17bfaedc75faa2c5db77bed5e9705b7780aa))
* add TMDB rate limit tracking with x-ratelimit-remaining support ([ed40415](https://github.com/SleepinDevil/aiometadata/commit/ed40415e7d1a3e9181b7bb21f6e2846701f9e275))
* add TMDB release date fetching for anime movies ([fbbd6bc](https://github.com/SleepinDevil/aiometadata/commit/fbbd6bcbe9844954d64d161cc9cc2fc1e432cfe1))
* add Trakt search ([b327237](https://github.com/SleepinDevil/aiometadata/commit/b327237a043e892c6261d06cd7e2e5bec261e687))
* **anilist:** Add AniList trending anime catalog ([a8df749](https://github.com/SleepinDevil/aiometadata/commit/a8df749c6873d94639a6ae741fcc8c7c0c13f95f))
* build your catalog ([1ef43a2](https://github.com/SleepinDevil/aiometadata/commit/1ef43a268b481f2b5e72e6cb5559ab94716e1722))
* **BYOC:** Add genres dropdown for built catalogs ([5f7fc56](https://github.com/SleepinDevil/aiometadata/commit/5f7fc5636f2d1b7e9662225c9653c68662c19e24))
* **byoc:** add MDBList Discover as a BYOC source with user info display ([44e04a0](https://github.com/SleepinDevil/aiometadata/commit/44e04a0687eacb0d2693c531a2a0e2f8de62cf1d))
* **BYOC:** add option to preview catalogs ([ea2c5ea](https://github.com/SleepinDevil/aiometadata/commit/ea2c5ea8cfb2ce85eaca627f95ee61a2b45d8710))
* **BYOC:** Make built catalog settings editable ([9472ca6](https://github.com/SleepinDevil/aiometadata/commit/9472ca621dfaf43301ea139608450573b92102bc))
* **BYOC:** Make some aiom default catalogs editable as BYOC ([6cdbb7f](https://github.com/SleepinDevil/aiometadata/commit/6cdbb7ff481af3e0f3251af5424c64f944d41ffc))
* **dashboard analytics:** revamp charts ui ([c19ad10](https://github.com/SleepinDevil/aiometadata/commit/c19ad10b153097e49199df4e23d5129c261549da))
* **dashboard:** add ability to lock dashboard from public completely ([b73933c](https://github.com/SleepinDevil/aiometadata/commit/b73933c21b4155d7b765ddeadec5341c6c4dfd8f))
* hide watched items from catalogs (Trakt, AniList, MDBList) ([5fedaa8](https://github.com/SleepinDevil/aiometadata/commit/5fedaa85febee5b35f84eabb364ddc4a937640b6))
* **letterboxd:** Add letterboxd integration with list/watchlist url import support ([47d0464](https://github.com/SleepinDevil/aiometadata/commit/47d0464d55dd58a8dd7a7b0be4ded5bba269e43a))
* **mdblist:** Add mdblist check in feature. Playback will now sync to mdblist via check in. ([35f9ffe](https://github.com/SleepinDevil/aiometadata/commit/35f9ffe557152f1dd79d82fba8fcf5b574ca4bf5))
* **mdblist:** add option to filter out unreleased shows from up next as shown in mdblist UI ([847fb28](https://github.com/SleepinDevil/aiometadata/commit/847fb28901e7ea8f550fb8cda219758925585fee))
* merge tmdb art requests and deduplicate in-flight ([322f08d](https://github.com/SleepinDevil/aiometadata/commit/322f08d68587b58f1721a5d0e0a58dde66f6c2c9))
* **rate me:** only add stream resource when rate me is activated ([38a2824](https://github.com/SleepinDevil/aiometadata/commit/38a282444e205fd3ad1d098018ee193d547e6cf8))
* remove cinemeta fallback from imdb ratings fetcher ([28bfbbc](https://github.com/SleepinDevil/aiometadata/commit/28bfbbc42c3c2b74697e9380cab3b7da930a9991))
* remove cinemeta fallback from imdb ratings fetcher ([c3fe45c](https://github.com/SleepinDevil/aiometadata/commit/c3fe45c91f56e4eb98ccb7f21b4ce936a0f97d44))
* revamp dash ([f552aab](https://github.com/SleepinDevil/aiometadata/commit/f552aabf7676a2d2b417ef8888239b1c463c4dce))
* revamp Error Management in dashboard ([4821f94](https://github.com/SleepinDevil/aiometadata/commit/4821f94ec909ba7106312c2e74cce9820c12dc52))
* revamp Error Management in dashboard ([a730932](https://github.com/SleepinDevil/aiometadata/commit/a730932befcc0c97350acba390c4c10720ae1884))
* revamp Maintenance Tasks, Provider Status & System Health, in dashboard ([4bf6c92](https://github.com/SleepinDevil/aiometadata/commit/4bf6c92723c364a34cec2db4ae5756bc5abdd38d))
* **search:** add mdblist as search provider ([2e805e2](https://github.com/SleepinDevil/aiometadata/commit/2e805e2a0cea6d5bbcffffe486cf12731cdf787f))
* **search:** add option to filter digital releases for searches only ([67f2ada](https://github.com/SleepinDevil/aiometadata/commit/67f2adaa7f293fea85b5e55d4d74f9cf91a9d7af))
* **search:** add search catalog type editing feature ([68bf7a9](https://github.com/SleepinDevil/aiometadata/commit/68bf7a911475b0120db92121a52ffcff17826d6c))
* separate people search from title search for tmdb/trakt/tvdb ([2956fbf](https://github.com/SleepinDevil/aiometadata/commit/2956fbf06c1593b5386e63147d2229b3d473591b))
* show reinstall warning when manifest-affecting config changes are saved ([5c02eb4](https://github.com/SleepinDevil/aiometadata/commit/5c02eb477d200e04c06245cda28fd304f438e101))
* simkl integration ([59e5aa8](https://github.com/SleepinDevil/aiometadata/commit/59e5aa835d86cd8220cd23fdedaa0e25afb60525))
* **simkl:** Add Simkl check in functionality for watch syncing ([238da3f](https://github.com/SleepinDevil/aiometadata/commit/238da3fdb25c916c89fa400b6bd41bead0746bfd))
* **simkl:** add simkl latest dvd release catalog ([b26fb75](https://github.com/SleepinDevil/aiometadata/commit/b26fb75b4119c11bd84d7bc1408d9b07d63ddc8b))
* **simkl:** implement local pagination for watchlists and date_from sync ([9c366fa](https://github.com/SleepinDevil/aiometadata/commit/9c366fa2161f9eee42c0482ddbe1d2f60f1a5bdc))
* **simkl:** improve watchlist support, ID filtering, and performance ([fa2edaf](https://github.com/SleepinDevil/aiometadata/commit/fa2edaf9adbd9afdee48caf13997771ec813cd0e))
* **simkl:** make SIMKL_ACTIVITIES_TTL configurable ([c15b5d1](https://github.com/SleepinDevil/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* support blur endpoint for TOP Poster API ([fc6143a](https://github.com/SleepinDevil/aiometadata/commit/fc6143a556dd983672c87e798a5f8721d88a9c6c))
* support blur endpoint for TOP Poster API ([424c127](https://github.com/SleepinDevil/aiometadata/commit/424c1271eef3a13e057337035c77f8778b935100))
* **trakt:** add "default" as sort option ([04247c1](https://github.com/SleepinDevil/aiometadata/commit/04247c142a71cddce6287ab4e3120d5e27f1c698))
* **trakt:** add trakt check in ([b26fb75](https://github.com/SleepinDevil/aiometadata/commit/b26fb75b4119c11bd84d7bc1408d9b07d63ddc8b))
* **trakt:** Add trakt trending/popular movies/shows catalogs ([911f4a1](https://github.com/SleepinDevil/aiometadata/commit/911f4a1d679f6528a93f9b70a9086d5561e0b22f))
* **ui:** add ability to move items in group ([c19ad10](https://github.com/SleepinDevil/aiometadata/commit/c19ad10b153097e49199df4e23d5129c261549da))


### Bug Fixes

* Add cache integrity checks and improve catalog warmer stats tracking ([a979caa](https://github.com/SleepinDevil/aiometadata/commit/a979caa7f111fefeead0c28ff773a307a0ccd52c))
* add media.kitsu.app to allowed domains and increase blur intensity ([1477dce](https://github.com/SleepinDevil/aiometadata/commit/1477dce279ea74146c7afa4059467f2cc89253f2))
* add metahub to trusted endpoints ([376abfd](https://github.com/SleepinDevil/aiometadata/commit/376abfdd69017a712f532efd0cde3da74ec0f8f5))
* add null checks for TMDB API responses to prevent fallback issues ([571448e](https://github.com/SleepinDevil/aiometadata/commit/571448e270928a4b694ef5ef8a17f71e07e90eae))
* add oom guardrails to maps ([1ef7706](https://github.com/SleepinDevil/aiometadata/commit/1ef77069e5e78f4667fa0d514059eb480354d6cf))
* add oom guardrails to maps ([1a382f1](https://github.com/SleepinDevil/aiometadata/commit/1a382f18ed0a99368230208ae064d799f336e016))
* add version prefix to component cache keys to prevent stale data ([ee11fe6](https://github.com/SleepinDevil/aiometadata/commit/ee11fe693f3a0006988c412685cf001d32348851))
* address TUN bug, enhance cache efficiency ([5fe3880](https://github.com/SleepinDevil/aiometadata/commit/5fe3880d0660d5edfe5067c2c0418cf66f7be295))
* AI search on without key when importing ([5dfc82b](https://github.com/SleepinDevil/aiometadata/commit/5dfc82b3334d2785338ac3c2bf079a248690da26))
* ai search re-ordering bug ([745b0f8](https://github.com/SleepinDevil/aiometadata/commit/745b0f8330037201a962083175f01cff3ff97fb0))
* allow anilist disconnect for guests ([9cb685a](https://github.com/SleepinDevil/aiometadata/commit/9cb685a8d73c2be39b7e997739b89745b3b4ddbe))
* allow anilist disconnect for guests ([89a1bcb](https://github.com/SleepinDevil/aiometadata/commit/89a1bcb6daf893be0c0d4bf68cb7fd39d2dc899c))
* allow guests to disconnect from trakt ([97f76c1](https://github.com/SleepinDevil/aiometadata/commit/97f76c176fa18ed92087fbe509d31e01982828b4))
* allow guests to disconnect from trakt ([c26980a](https://github.com/SleepinDevil/aiometadata/commit/c26980ae8675789f90527c7ad2324a5f54ae4b2f))
* allow pressing Enter on save config modal ([21e07f6](https://github.com/SleepinDevil/aiometadata/commit/21e07f632f135972f40e98a4b1544a610b4d9c11))
* **anilist & trakt:** fix expiry date retrieval for pg users ([6cdbb7f](https://github.com/SleepinDevil/aiometadata/commit/6cdbb7ff481af3e0f3251af5424c64f944d41ffc))
* **anilist:** add genres filtering to anilist trending ([2e03ac2](https://github.com/SleepinDevil/aiometadata/commit/2e03ac24e806c29d7c6369a18cbbc745c9b348a4))
* **anilist:** prevent status lists from showing hidden entries ([8b3c679](https://github.com/SleepinDevil/aiometadata/commit/8b3c6790e5f055bc0a8352bb3e155167813c5b61))
* **anilist:** stable pagination and sort-aware caching ([ebab787](https://github.com/SleepinDevil/aiometadata/commit/ebab787cbef178f172cedb04ff97ae5ff94c5ce6))
* **Anime mapping:** Update TVDB ID property name from thetvdb_id to tvdb_id to match upstream mapping changes ([44c2dff](https://github.com/SleepinDevil/aiometadata/commit/44c2dffe95ecff9434a3dc83b61cb0a5b290aefc))
* apply digital release filter to Trakt/MDBList lists with type 'all' ([cd7d8c6](https://github.com/SleepinDevil/aiometadata/commit/cd7d8c69117ba53260d9aca01483fb24a91a7b71))
* apply showPrefix to all catalog types ([a3443d5](https://github.com/SleepinDevil/aiometadata/commit/a3443d53b4da12d6f5de77333277bc6ecefaf6db))
* avoid caching null ratings whilst IMDB dataset is updating ([3a6e60e](https://github.com/SleepinDevil/aiometadata/commit/3a6e60e74cbaff4ccbd0206cd60333df9ed60dc4))
* avoid caching null ratings whilst IMDB dataset is updating ([9a4dd24](https://github.com/SleepinDevil/aiometadata/commit/9a4dd24784b51e52ed2c50fd1f266b1b85a7df52))
* bump version ([#363](https://github.com/SleepinDevil/aiometadata/issues/363)) ([c031827](https://github.com/SleepinDevil/aiometadata/commit/c031827a4679955ae5e4a87a5f5ba2f028119c6b))
* **BYOC:** Add year input for simkl ([e0a3126](https://github.com/SleepinDevil/aiometadata/commit/e0a3126b2354a6558358848aae6bcfe91d7a0ceb))
* **BYOC:** fix air dates not being set correctly for tmdb now airing ([b3ba6bc](https://github.com/SleepinDevil/aiometadata/commit/b3ba6bc397d14cf07b2cfc96366e9201bfce8474))
* **BYOC:** fix catalog context not being reset for cloned catalogs ([b3ba6bc](https://github.com/SleepinDevil/aiometadata/commit/b3ba6bc397d14cf07b2cfc96366e9201bfce8474))
* **byoc:** preserve randomization on save, fix MAL catalog type, and prevent state leaking between edits ([bd023d9](https://github.com/SleepinDevil/aiometadata/commit/bd023d96e86bf39963614ea13b4436f3beadf251))
* **cache:** add auto cleanup of old meta cache keys on version change ([a2ae76b](https://github.com/SleepinDevil/aiometadata/commit/a2ae76b8012eb942ba0a096fe5b01cc913216c35))
* **cache:** avoid caching empty data returned by api providers ([50fb58f](https://github.com/SleepinDevil/aiometadata/commit/50fb58f283fcbde807294891ea0549ba9594cd3c))
* **cache:** hash config in cache keys to avoid generating big string ([a2ae76b](https://github.com/SleepinDevil/aiometadata/commit/a2ae76b8012eb942ba0a096fe5b01cc913216c35))
* **catalog-warmer:** update Simkl pageSize handling for watchlists ([3acc908](https://github.com/SleepinDevil/aiometadata/commit/3acc9083f247d3a2d746ab2a04886f05e992de76))
* clean logs ([0fa7c74](https://github.com/SleepinDevil/aiometadata/commit/0fa7c74c94b53ef31cab4a612cfef5b073b43687))
* clean logs ([0401077](https://github.com/SleepinDevil/aiometadata/commit/04010770c13034fdb92eb668b4294576ad29db43))
* **cleanup:** update version cleanup regex for semver tags ([c15b5d1](https://github.com/SleepinDevil/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* correct type issue when setting specific display types like streaming provider name ([bb0b265](https://github.com/SleepinDevil/aiometadata/commit/bb0b265ed77ea08aab13868435b015cf513983cf))
* enable necessary metrics for Ratings page functionality ([95e63bd](https://github.com/SleepinDevil/aiometadata/commit/95e63bd5cb7f2b8cf60baf38481777098641717e))
* enable necessary metrics for Ratings page functionality ([7a6a419](https://github.com/SleepinDevil/aiometadata/commit/7a6a419762a6b50ba5dee4ed7862f86d16d15926))
* ensure MDBList API key test uses rate limiter ([0e40ba4](https://github.com/SleepinDevil/aiometadata/commit/0e40ba4e73368ba23edef9a747a52e20b7494f27))
* filter out spam entries from TMDB airing today catalog ([591d265](https://github.com/SleepinDevil/aiometadata/commit/591d265460f4cbe74d5c0f5505da62b749227cf4))
* **filter:** fix digital release to check for tmdb release info even when movie release date is not available ([a7ae085](https://github.com/SleepinDevil/aiometadata/commit/a7ae085a26198db2bee1caf9fabd151d9e09d1ea))
* Fixed issue with IMDb ratings not being correctly retrieved for tmdb series. ([1c85701](https://github.com/SleepinDevil/aiometadata/commit/1c8570136be4226f53e54ad5886dd095e2d84d38))
* **getCache:** pass cacheKey to TVDB classifier to fix TTL:0 skip, remove version from TVDB cache keys ([7c4c59e](https://github.com/SleepinDevil/aiometadata/commit/7c4c59ed80cb5a1a35694dc6910280dada770198))
* **getMeta:** guard imdbData.links and links array before unshift ([db633ec](https://github.com/SleepinDevil/aiometadata/commit/db633ec46ff3b23af2366adbf2d9f21df9f84340))
* id mapper parsing ([5f3f590](https://github.com/SleepinDevil/aiometadata/commit/5f3f5909d7dfaf402670212f9f352013691b7bd3))
* id mapper parsing ([edd5973](https://github.com/SleepinDevil/aiometadata/commit/edd59730e0d3ab87ba389ae21c81f14be605e6ad))
* **id-mapper:** add null checks for Cinemeta response data ([7c4c59e](https://github.com/SleepinDevil/aiometadata/commit/7c4c59ed80cb5a1a35694dc6910280dada770198))
* **imdb meta:** show age rating for imdb meta ([3ce2ba7](https://github.com/SleepinDevil/aiometadata/commit/3ce2ba77c44e1f7d44a0c4c64a173692f13fae5e))
* **import:** fix import showing new catalogs instead of imported config ([199aebc](https://github.com/SleepinDevil/aiometadata/commit/199aebc5588e63fb05a85074fa38d3a0bb27ca69))
* **kitsu search:** fix anime tv types set definition ([2063214](https://github.com/SleepinDevil/aiometadata/commit/2063214a81ea9f4e17b86d30cccc84c2dcc4b4dc))
* **kitsu:** fix language fallback logic ([af1972e](https://github.com/SleepinDevil/aiometadata/commit/af1972e915e2c3ed2adfc386e4ec24d49e3109e8))
* lbox id extraction ([807d483](https://github.com/SleepinDevil/aiometadata/commit/807d4833f98ff14d0a6ed52224b80751b5485cc7))
* lbox id extraction ([f566a1a](https://github.com/SleepinDevil/aiometadata/commit/f566a1ad89c70b095effe6c36bb680a64f4b4b07))
* **letterboxd:** fix error when letterboxd would return type show for series ([f1ce58c](https://github.com/SleepinDevil/aiometadata/commit/f1ce58c726376d1358410c7e869b97d250f6faab))
* **letterboxd:** fix variable scope issue ([b323b7a](https://github.com/SleepinDevil/aiometadata/commit/b323b7aa2715efcfa78394cfde362dc67bee6a35))
* loading watch provider being overriden in edit mode ([c07e15b](https://github.com/SleepinDevil/aiometadata/commit/c07e15b3802f689cd7ee39bc1bde19b2174119e5))
* **manifest:** make id generation more unique to fix edge cases with display types ([aee5a5b](https://github.com/SleepinDevil/aiometadata/commit/aee5a5b5537d81f2f13a8ba53454f41c57a9ce8d))
* **mappings:** update mapping url following change by remote db ([a7ae085](https://github.com/SleepinDevil/aiometadata/commit/a7ae085a26198db2bee1caf9fabd151d9e09d1ea))
* **mdblist:** fix import by list url ([2778c7a](https://github.com/SleepinDevil/aiometadata/commit/2778c7ad9043e6b773f6a9c484755b6edf816fae))
* **mdblist:** fix list type assignement when adding lists via username ([136a477](https://github.com/SleepinDevil/aiometadata/commit/136a4779bb86326d8339294fb2b0bc1131d4ecb1))
* **mdblist:** fix meta issue arising when use show poster was on for mdb upnext ([7536c8e](https://github.com/SleepinDevil/aiometadata/commit/7536c8e9346ea0cde551e20699c52a869da3b697))
* **mdblist:** implement a per key rate limiter to avoid global cooldown ([f1ce58c](https://github.com/SleepinDevil/aiometadata/commit/f1ce58c726376d1358410c7e869b97d250f6faab))
* **mdblist:** pass unified paramater to query for mixed lists so that order is kept ([2778c7a](https://github.com/SleepinDevil/aiometadata/commit/2778c7ad9043e6b773f6a9c484755b6edf816fae))
* **mdblist:** prevent season items from being fetched in user lists ([4daf969](https://github.com/SleepinDevil/aiometadata/commit/4daf9697f773675fcc81af99076c1e452d73f589))
* **mdblist:** prioritize list slug for url generation ([c15b5d1](https://github.com/SleepinDevil/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* **mdblist:** use list.shows instead of list.items_shows to get shows count ([c8cf543](https://github.com/SleepinDevil/aiometadata/commit/c8cf543d90a98216bd146ffa8994aca51bb63ca4))
* memory usage displaying NaN ([b4b2227](https://github.com/SleepinDevil/aiometadata/commit/b4b222799e0c34dc7fa9d6e09c33a19536232dfd))
* multi dragging ([45f0377](https://github.com/SleepinDevil/aiometadata/commit/45f0377dfc618e34b2891d37b60f3d1f6ca08e82))
* multi dragging ([d6a67b5](https://github.com/SleepinDevil/aiometadata/commit/d6a67b5782f7a67bf1745cda81d7a3bdb054d442))
* multiple search and thumbnail improvements ([bd904ad](https://github.com/SleepinDevil/aiometadata/commit/bd904ad7b208572779b359d460e024b9d26e6ddc))
* prioritize background over season poster for unaired episode thumbnails ([04df2b0](https://github.com/SleepinDevil/aiometadata/commit/04df2b06c6862eada3ac57cb1ab5483e5b67e33b))
* proxy frontend Trakt calls through backend rate limiter ([17d80b7](https://github.com/SleepinDevil/aiometadata/commit/17d80b7e71ef75a44cc52809cb8b7bd29aaa77fd))
* remove reservoir from bottleneck ([5364249](https://github.com/SleepinDevil/aiometadata/commit/536424916236e273c2b2b0998abc201472287fa4))
* rename searches instead of providers for independent naming ([bd904ad](https://github.com/SleepinDevil/aiometadata/commit/bd904ad7b208572779b359d460e024b9d26e6ddc))
* resolve 'retain' anime_id_provider to actual provider for correct episode IDs ([403fcd3](https://github.com/SleepinDevil/aiometadata/commit/403fcd3a92f8777efe47eb16f1e57a002d85ebc8)), closes [#263](https://github.com/SleepinDevil/aiometadata/issues/263)
* resolve cache poisoning and improve anime detection ([fdde48e](https://github.com/SleepinDevil/aiometadata/commit/fdde48e7e5c7ded538eb9641e2910bb68905ce94))
* resolve undefined skip and pageSize references after page-based refactor ([cb83e5d](https://github.com/SleepinDevil/aiometadata/commit/cb83e5d8364452fe40ecb31e1ab257b26af1398a))
* revert bottleneck implementation ([9b4f186](https://github.com/SleepinDevil/aiometadata/commit/9b4f1863746a9ff164e662cf7de4096b053f206e))
* RPDB/TOP adoption metrics stuck at 0% in admin dashboard ([769da77](https://github.com/SleepinDevil/aiometadata/commit/769da770ae7aec6b1ccaf263a97ba7cdd13085ac))
* RPDB/TOP adoption metrics stuck at 0% in admin dashboard ([f32daea](https://github.com/SleepinDevil/aiometadata/commit/f32daea203d7ac112961171e882e14ef97f70720))
* **search filter:** fix search filtering by catalog vs search ([a200eac](https://github.com/SleepinDevil/aiometadata/commit/a200eacd55cb111f5beec604259c8107c60c54dc))
* **search:** add search type to cachekey for cache key singularity ([c0498a8](https://github.com/SleepinDevil/aiometadata/commit/c0498a807f44326f493a3d31af6e2950ae888cc5))
* **search:** ensure search cache key is unique for each search type ([b323b7a](https://github.com/SleepinDevil/aiometadata/commit/b323b7aa2715efcfa78394cfde362dc67bee6a35))
* **search:** fix digital release filter not being correctly disabled for search only ([fa17c2f](https://github.com/SleepinDevil/aiometadata/commit/fa17c2fee361021d00e4e102c53819dde7006a88))
* **search:** fix forced person search call in tmdb/tvmaze ([231b949](https://github.com/SleepinDevil/aiometadata/commit/231b949f1f35d76d794b276ac638f2695cd92dbf))
* **simkl checkin:** Add fallback ids to MAL  when simkl cant find metadata via tvdb for anime and fix season fetching for anidb --&gt; tvdb ([1526a97](https://github.com/SleepinDevil/aiometadata/commit/1526a9745e460d1bb228959b9db4bc8f824cd808))
* **simkl:** fix plan to watch and on hold items order ([cc56f96](https://github.com/SleepinDevil/aiometadata/commit/cc56f9611bd3b36d19c692c41bcbfa29404394b0))
* **simkl:** fix simkl trending and calendar not being accessible without login ([28ed1e6](https://github.com/SleepinDevil/aiometadata/commit/28ed1e69afa3b9d051bb6112b100bf3b863a1246))
* **simkl:** fix stats not being displayed ([9253218](https://github.com/SleepinDevil/aiometadata/commit/92532188ae890af3d13d8e473ebc9daa795591bc))
* **simkl:** only showing series that have unwatched episodes remaining in user watchlists ([8b3c679](https://github.com/SleepinDevil/aiometadata/commit/8b3c6790e5f055bc0a8352bb3e155167813c5b61))
* **simkl:** use empty string and 0 instead of null for refresh_token and expires_at ([7bbe929](https://github.com/SleepinDevil/aiometadata/commit/7bbe9291229dd416d34097e9a00f60f23ff86a80))
* sync AI toggle when disabling AI search in sortable list ([bd904ad](https://github.com/SleepinDevil/aiometadata/commit/bd904ad7b208572779b359d460e024b9d26e6ddc))
* **tmdb movie:** fix duplicate directors link ([568a068](https://github.com/SleepinDevil/aiometadata/commit/568a068f2f32bb5507d1ee7e3cbd3e8d1c147d8a))
* **tmdb people search:** reduce popularity threshold and improve logic ([978742b](https://github.com/SleepinDevil/aiometadata/commit/978742b7081fc67481b2da6f26cfd32d5801db95))
* **tmdb top rated:** increase vote count to filter trash out ([a4b84c9](https://github.com/SleepinDevil/aiometadata/commit/a4b84c928e335140de9219dce69ba3a0df77d856))
* **tmdb:** fix crew photo path ([2e805e2](https://github.com/SleepinDevil/aiometadata/commit/2e805e2a0cea6d5bbcffffe486cf12731cdf787f))
* **TOP Posters:** fix top rating posters still showing in library when Keep Rating Posters for Library Items was false ([4834d73](https://github.com/SleepinDevil/aiometadata/commit/4834d73161b11fbc0647def35b3abeb1d35d2c38))
* **TOP:** fix AI search not using TOP Posters API ([47a253e](https://github.com/SleepinDevil/aiometadata/commit/47a253e4d049612435c4d99c9dbd868aed17100f))
* touch-up kitsu ([9818288](https://github.com/SleepinDevil/aiometadata/commit/9818288026d9fa38e0d74853f7a8808af9473ca9))
* **trakt genres:** show name instead of slug in stremio ([1f0cf69](https://github.com/SleepinDevil/aiometadata/commit/1f0cf697b632e87135f736525793c10113028994))
* trakt handling enhancements ([e4f249e](https://github.com/SleepinDevil/aiometadata/commit/e4f249e0e05352ad48365aab8bca82c1960d32d7))
* trakt handling enhancements ([921bc66](https://github.com/SleepinDevil/aiometadata/commit/921bc661f6cf88ede70599ef335dfb920759afe9))
* trakt refresh token logic ([0f37952](https://github.com/SleepinDevil/aiometadata/commit/0f379521397570c9b7b195945f4dfce97008e5a9))
* trakt refresh token logic ([e79b3a6](https://github.com/SleepinDevil/aiometadata/commit/e79b3a62e02cf38106f98ce637feaf3d49f4b22e))
* trakt token update logic ([4d0aea1](https://github.com/SleepinDevil/aiometadata/commit/4d0aea154a79450430855734b3fbfbf003016980))
* trakt token update logic ([8af1a4b](https://github.com/SleepinDevil/aiometadata/commit/8af1a4b94924d5c225047a0a17e3624961b53cad))
* **trakt:** add DISABLE_TRAKT_SEARCH env to let instances disable trakt search for better rate limit handling ([799652f](https://github.com/SleepinDevil/aiometadata/commit/799652f2bace0d49acfbdd545336f8add8681eb6))
* **trakt:** Filter dropped shows from Trakt Up Next and Recently Aired catalogs ([9cea060](https://github.com/SleepinDevil/aiometadata/commit/9cea060b61b62a0129baa723917ecba819d38fe3))
* **Trakt:** fix Trakt OAuth 301 redirect error ([afe6e26](https://github.com/SleepinDevil/aiometadata/commit/afe6e269a6dd7827482612f38df4727dd2fdf545))
* **trakt:** improve routing of auth'ed vs unauth'ed requests to correct queue for trakt rate limits handling ([77f64f5](https://github.com/SleepinDevil/aiometadata/commit/77f64f57fa2ddc9e1dbd29f52b492c8e7f7f7224))
* **trakt:** improve routing of auth'ed vs unauth'ed requests to correct queue for trakt rate limits handling ([c0c860d](https://github.com/SleepinDevil/aiometadata/commit/c0c860dd83a39e7f40eaa61bf077127bdccf1a95))
* **trakt:** overhaul rate limit handling to better handle load ([a66db07](https://github.com/SleepinDevil/aiometadata/commit/a66db07d30b5dfce3efae8bcc4a50886db0b46c3))
* **trakt:** pass proxy dispatcher to post requests in trakt.ts ([441d7b2](https://github.com/SleepinDevil/aiometadata/commit/441d7b2c60189eefb29b39a7d6d1ab4f41112142))
* **trakt:** prevent manifest from hanging due to trakt genres ([ef02401](https://github.com/SleepinDevil/aiometadata/commit/ef024012d549301e418bbd1f6eac6c19b762dcba))
* **tvdb art:** refine english only art logic to exclude backgrounds ([70c9cd8](https://github.com/SleepinDevil/aiometadata/commit/70c9cd891f2f3fd1f968d8e9bc2fb227db71abc7))
* tvdb episode fetching error ([2a52d5f](https://github.com/SleepinDevil/aiometadata/commit/2a52d5fa62667ee9820058bd3c8a9d1621f37be4))
* **tvdb meta for anime:** add fallback to tvdb's db imdb id when anime mapping fails ([a82dad6](https://github.com/SleepinDevil/aiometadata/commit/a82dad664e265b24b22d09736c9a312eeabe6ce2))
* **tvdb trending:** improve tvdb trending fetching logic ([f574204](https://github.com/SleepinDevil/aiometadata/commit/f5742045d3bd02e16d19eee300aa048d446823ab))
* **tvdb:** convert years to season numbers for shows that use season years as season numbers ([9bf0803](https://github.com/SleepinDevil/aiometadata/commit/9bf0803db3e9368f76f770e5d805daf991da3a1f))
* **tvdb:** order cast by tvdb sort property and isFeatured instead of returning the raw order. ([35f9ffe](https://github.com/SleepinDevil/aiometadata/commit/35f9ffe557152f1dd79d82fba8fcf5b574ca4bf5))
* TVmaze rate limiting ([98471d7](https://github.com/SleepinDevil/aiometadata/commit/98471d736508d670ee431c7d8d199c046bd8df44))
* **ui:** fix ratings icon having to be double clicked sometimes to change the state/ catalog ([a7ae085](https://github.com/SleepinDevil/aiometadata/commit/a7ae085a26198db2bee1caf9fabd151d9e09d1ea))
* **ui:** hide cache ttl option and settings gear for simkl watchlist ([c15b5d1](https://github.com/SleepinDevil/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* **UI:** make sure Enable Gemini search is disabled AND toggled off when no api key is entered ([4834d73](https://github.com/SleepinDevil/aiometadata/commit/4834d73161b11fbc0647def35b3abeb1d35d2c38))
* **up next:** Exclude episodes without air date from Trakt Up Next and exclude MDBList Up Next from catalog warmer ([1915305](https://github.com/SleepinDevil/aiometadata/commit/191530582b4fb06f491a24d08faa27634615661a))
* **up next:** prevent rpdb from applying to thumbnails ([fa17c2f](https://github.com/SleepinDevil/aiometadata/commit/fa17c2fee361021d00e4e102c53819dde7006a88))
* update invalidation patterns ([f4d1d36](https://github.com/SleepinDevil/aiometadata/commit/f4d1d368ccbc07be830943051ce198482715667e))
* update redis memory calculation in cache management UI element ([537b918](https://github.com/SleepinDevil/aiometadata/commit/537b91839d7aaf966ceaabe95f3ab62ff8b5aa56))
* update redis memory calculation in cache management UI element ([59d964e](https://github.com/SleepinDevil/aiometadata/commit/59d964e8fa652f76d4ac4187a69675426a524337))
* use AniList format field to determine movie vs series ([ffb3051](https://github.com/SleepinDevil/aiometadata/commit/ffb305184d4e90e7b949bc29e4d9b54a1b1afa2b))
* use mdblistType instead of type ([63ce8fc](https://github.com/SleepinDevil/aiometadata/commit/63ce8fca67ea4575870aff5e8ec941997f927725))
* use mdblistType instead of type ([85295b0](https://github.com/SleepinDevil/aiometadata/commit/85295b0282293f8a6d532f77d6b3b71318981759))
* use retry-after header for tvmaze ([b474656](https://github.com/SleepinDevil/aiometadata/commit/b4746567e27fbce9b42010b42e4c5fc2e7a81097))
* use unified true for MDBList lists imported via username ([a5e10dd](https://github.com/SleepinDevil/aiometadata/commit/a5e10dd92d9950cb979353b6a76299a67b0a0927))
* **user management:** resolve issue with password reset ([4be921a](https://github.com/SleepinDevil/aiometadata/commit/4be921abc54654e83766a90f10ad7d68e8cb3bec))
* **warming:** Fix byoc warming that was broken due to missing dependency ([04247c1](https://github.com/SleepinDevil/aiometadata/commit/04247c142a71cddce6287ab4e3120d5e27f1c698))
* **warming:** fix undefined var breaking warming ([9472ca6](https://github.com/SleepinDevil/aiometadata/commit/9472ca621dfaf43301ea139608450573b92102bc))
* **warming:** resolve issue with kitsu ids reverting to imdb id ([9fe3ddf](https://github.com/SleepinDevil/aiometadata/commit/9fe3ddf7f45b96b75b43d3e6eee1f8cf35e9ac76))
* watch region being overriden in edit mode ([edf90e5](https://github.com/SleepinDevil/aiometadata/commit/edf90e51c3bbba2138bb9555c722dfc08148e330))
* wiki-mapper and IMDb ratings scheduled updates, Simkl improvements, TVDB cache fix ([7c4c59e](https://github.com/SleepinDevil/aiometadata/commit/7c4c59ed80cb5a1a35694dc6910280dada770198))


### Performance Improvements

* **anilist && trakt:** imporve token handling ([e8b1ccb](https://github.com/SleepinDevil/aiometadata/commit/e8b1ccb09698fec4989aa2a3c7bf39341fa37707))
* cache anime-list season groups and episode mapping parses ([2e37be7](https://github.com/SleepinDevil/aiometadata/commit/2e37be760d35eb4c7f9e3bde02322776e65d63b3))
* cache-wrap TMDB API methods for better performance ([fbbd6bc](https://github.com/SleepinDevil/aiometadata/commit/fbbd6bcbe9844954d64d161cc9cc2fc1e432cfe1))
* **cache:** refactor redis cache cleanup to use SCAN ([c15b5d1](https://github.com/SleepinDevil/aiometadata/commit/c15b5d190f766061aaab0831a1c6fe4a161ab575))
* enable auto pipelining ([#376](https://github.com/SleepinDevil/aiometadata/issues/376)) ([6129570](https://github.com/SleepinDevil/aiometadata/commit/612957094d17106f9d0a889a7a9907e0fd203a3a))
* improve MAL/Jikan API request handling and caching ([54a0c85](https://github.com/SleepinDevil/aiometadata/commit/54a0c8569ffa907b89d23e8ab6003c9e204be9e7))
* improve up next fetching logic for speed ([79c51ec](https://github.com/SleepinDevil/aiometadata/commit/79c51ec995a766e65b07674dfb7d1023cc6ef552))
* **mal:** improve rate limit and concurrency ([e8b1ccb](https://github.com/SleepinDevil/aiometadata/commit/e8b1ccb09698fec4989aa2a3c7bf39341fa37707))
* optimize etag logic ([4e42d9a](https://github.com/SleepinDevil/aiometadata/commit/4e42d9ad28647960ac02b0bd27fcf5e7864607e3))
* optimize id-mapper lookups ([6b4c71b](https://github.com/SleepinDevil/aiometadata/commit/6b4c71beef85c0dcb68cb09bc8a7f89f179fd76e))
* parallelize calls in parseProps.js ([820e3c9](https://github.com/SleepinDevil/aiometadata/commit/820e3c99c49f67710415e299315937673d58d39a))
* pre-compute langCode3 once and re-use ([6d0e31d](https://github.com/SleepinDevil/aiometadata/commit/6d0e31d6a3024d8cb858366fe253b56e2c1b8d0f))
* switch Simkl trending fetch to JSON source ([48e7f37](https://github.com/SleepinDevil/aiometadata/commit/48e7f37d5800652537182290db60ecf54f29ca13))
* **tmdb people search:** improve tmdb people search performance ([3a6e876](https://github.com/SleepinDevil/aiometadata/commit/3a6e8760f0bc4269c181cd23a7e6b844ab7f277c))
* **tmdb:** optimize request handling and rate limiting ([af1972e](https://github.com/SleepinDevil/aiometadata/commit/af1972e915e2c3ed2adfc386e4ec24d49e3109e8))


### Reverts

* discard getMeta.js changes from PR 181 ([3dd7ddf](https://github.com/SleepinDevil/aiometadata/commit/3dd7ddfef51cdd54f15f7538f22001b85fa56cee))
* temporarily revert to fribbs previous list update containing imdb ids ([a980fe1](https://github.com/SleepinDevil/aiometadata/commit/a980fe16d770286b0a25af1d58bb73050ce7c2e8))
